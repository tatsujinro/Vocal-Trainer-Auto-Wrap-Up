...
<head>
    ...
    <style>
        ...
        .hud-score {
            position: absolute; top: 15px; right: 15px; font-size: 1.5rem; font-weight: bold; color: white; text-shadow: 0 0 10px var(--accent);
        ...
        .score-circle {
            ...
            display: flex; justify-content: center; align-items: center; font-size: 2.5rem; font-weight: bold; color: white;
...
<body>
    ...
    function previewPatternVisuals(root, startTime, beatDur) {
        ...
        for(let i=0; i<intervals.length; i++) {
            ...
            gameTargets.push({ midi: noteMidi, startTime: noteTime, duration: beatDur * 0.95 });
        }
    }
